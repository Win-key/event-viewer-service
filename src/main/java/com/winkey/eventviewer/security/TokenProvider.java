package com.winkey.eventviewer.security;
...
public class TokenProvider {
    ...
    public void postConstruct(){
        ...
        this.secretKey = Base64.getEncoder().encodeToString(env.getProperty("jwt.signing.key").getBytes());

        String expireProps = env.getProperty("jwt.expire");
